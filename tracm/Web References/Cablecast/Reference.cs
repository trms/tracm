...
namespace tracm.Cablecast {
    ...
    public partial class CablecastWS : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public int CreateNewShowRecord(string LocalID, int LocationID, string Title, string CGTitle, int ProjectID, bool CGExempt, int ProducerID, [System.Xml.Serialization.XmlArrayItemAttribute(IsNullable=false)] NewReel[] Reels, int CategoryID, System.DateTime EventDate, string Comments, [System.Xml.Serialization.XmlArrayItemAttribute(IsNullable=false)] CustomField[] CustomFields, string username, string password) {
        ...
        /// <remarks/>
        public void CreateNewShowRecordAsync(string LocalID, int LocationID, string Title, string CGTitle, int ProjectID, bool CGExempt, int ProducerID, NewReel[] Reels, int CategoryID, System.DateTime EventDate, string Comments, CustomField[] CustomFields, string username, string password) {
            this.CreateNewShowRecordAsync(LocalID, LocationID, Title, CGTitle, ProjectID, CGExempt, ProducerID, Reels, CategoryID, EventDate, Comments, CustomFields, username, password, null);
        }
        
        /// <remarks/>
        public void CreateNewShowRecordAsync(string LocalID, int LocationID, string Title, string CGTitle, int ProjectID, bool CGExempt, int ProducerID, NewReel[] Reels, int CategoryID, System.DateTime EventDate, string Comments, CustomField[] CustomFields, string username, string password, object userState) {
        ...
        /// <remarks/>
        public void UpdateShowRecordAsync(int ShowID, string LocalID, string Title, string CGTitle, int ProjectID, bool CGExempt, int ProducerID, int CategoryID, System.DateTime EventDate, string Comments, CustomField[] CustomFields, string username, string password) {
            this.UpdateShowRecordAsync(ShowID, LocalID, Title, CGTitle, ProjectID, CGExempt, ProducerID, CategoryID, EventDate, Comments, CustomFields, username, password, null);
        }
        
        /// <remarks/>
        public void UpdateShowRecordAsync(int ShowID, string LocalID, string Title, string CGTitle, int ProjectID, bool CGExempt, int ProducerID, int CategoryID, System.DateTime EventDate, string Comments, CustomField[] CustomFields, string username, string password, object userState) {
